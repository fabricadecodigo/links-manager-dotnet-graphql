...
namespace LinkManager.Api.GraphQL.Api.Account
{
    ...
    {
        public async Task<ForgotPasswordExpiredResponse> ForgotPasswordExpired(
            [Service] IForgotPasswordExpiredHandler handler, 
            ForgotPasswordExpiredRequest request)
        {
